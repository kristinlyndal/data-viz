...
I appreciate the breakdown of this critique method, and it helped lead me to "Engagement" being the major aspect I wanted to change. There are aspects of the Good Charts critique method that I found useful and decided to incorporate as well, such as noting what we see first and breaking it down by elements like color and typography. I incorporated elements from Good Charts into Few's method.
